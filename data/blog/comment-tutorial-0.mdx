---
title: 'Build comments section with Next.js, SWR and Supabase - Part 0. Getting Started'
publishedAt: '2022-01-19'
summary: "We'll learn how to build a comments section that with awesome Next.js + SWR + Supabase"
image: '/static/images/blog/comment-tutorial/intro.png'
...
Hi yall folks! In this series, we will use sexy combination - Next.js + SWR + Supbase - to build a comment section, just like my blog's comment sections has down below.
...
- [SWR](https://swr.vercel.app/): Super-easy data fetching/caching library
- [Supabase](https://supabase.com/): Trendy BaaS(Backend as a Service) product for PostgreSQL lovers

And also my favorite CSS framework, the [TailwindCSS](https://tailwindcss.com/).
