...
Hi yall folks! In this series, we will use sexy combination - Next.js + Supbase - to build a comment section, just like my blog's comment sections has down below.
